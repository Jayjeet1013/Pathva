        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 lg:gap-x-20 gap-y-10">
          <div className="flex flex-col justify-between lg:py-5">
            <h2 className="text-3xl font-bold leading-tight text-white sm:text-4xl lg:leading-tight lg:text-5xl">
              Discover the Best Travel Destinations with PathavaAI
            </h2>
            ...
            <div className="mt-auto">
              ...
              <blockquote className="mt-6">
                <p className="text-lg leading-relaxed text-white">
                  PathavaAI made planning my trip effortless. It suggested
                  amazing places, and the recommendations were spot on. Highly
                  recommended!
                </p>
              </blockquote>
              ...
              <div className="flex items-center mt-8">
                ...
                <div className="ml-4">
                  ...
                  <p className="mt-px text-sm text-gray-400">Traveler</p>
                </div>
              </div>
            </div>
          </div>
